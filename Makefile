...
generate: snips ../shanhe-api-specs/package.json
	./snips \
		-f=../shanhe-api-specs/2013-08-30/swagger/api_v2.0.json \
		-t=./template \
		-o=./service
	go fmt ./service/...
	@echo "ok"
...
../shanhe-api-specs/package.json:
	-go get -d github.com/yunify/shanhe-api-specs
	file %@
...
unit-coverage:
	...
	for pkg in ${PKGS_TO_CHECK}; do \
		output="coverage$${pkg#github.com/yunify/shanhe-sdk-go}"; \
		mkdir -p $${output}; \
...
ADD . /go/src/github.com/yunify/shanhe-sdk-go
WORKDIR /go/src/github.com/yunify/shanhe-sdk-go
