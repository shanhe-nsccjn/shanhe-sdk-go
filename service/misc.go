...
func (s *ShanHeService) Misc() (*MiscService, error) {
	properties := &MiscServiceProperties{}

	return &MiscService{Config: s.Config, Properties: properties}, nil
}

// Documentation URL: https://docsv3.shanhe.com/product/api/action/misc/get_quota_left.html
...
// Documentation URL: https://docsv3.shanhe.com/product/api/action/misc
