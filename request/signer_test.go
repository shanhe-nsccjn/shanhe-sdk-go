...
import (
	...
	"github.com/shanhe-nsccjn/shanhe-sdk-go/utils"
)
...
func TestSigner1(t *testing.T) {
	url := "https://api.qc.dev/iaas/?action=RunInstances&count=1&image_id=centos64x86a&instance_name=demo&instance_type=small_b&login_mode=passwd&login_passwd=ShanHe20130712&signature_method=HmacSHA256&signature_version=1&time_stamp=2013-08-27T14%3A30%3A10Z&version=1&vxnets.1=vxnet-0&zone=pek1"
	httpRequest, err := http.NewRequest("GET", url, nil)
