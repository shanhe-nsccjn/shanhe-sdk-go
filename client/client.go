...
import (
	...
	"github.com/shanhe-nsccjn/shanhe-sdk-go/service"
)
...
// ShanHeClient ShanHe IaaS Advanced Client
type ShanHeClient interface {
...
// NewClient return a new ShanHeClient
func NewClient(config *config.Config, zone string) (ShanHeClient, error) {
